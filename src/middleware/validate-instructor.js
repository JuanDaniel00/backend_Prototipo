...
const  validateInstructors = async (req, res, next) => {
    ...
    try {
        const validate = await axios.post(`${REPFORA}/api/instructors/token/productive/stages`, null, {
            headers: { token: token }
        });
